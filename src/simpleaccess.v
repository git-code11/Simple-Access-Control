...
// =============================================================
// Access Control FSM — Tiny Tapeout 06
//
// FIXES APPLIED:
//   - Added start_5s_timer / start_30s_timer output ports
//   - S3_DENIED now holds for ~1 second so red_led is visible
//   - fail_counter saturates at 3 (no wraparound risk)
//   - parameter → localparam (synthesis-safe for TT06 / OpenLane)
//   - admin_reset passed through 2-stage synchronizer
// =============================================================
module access_control (
    input  wire clk,
    input  wire reset_n,
